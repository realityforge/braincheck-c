...
TEST_CASE("braincheck_debug - ansi")
{
    ...
    REQUIRE_THAT(message, EndsWith(":\u001B[0m \u001B[36m\u001B[1m1 == 1 ? true : false\u001B[0m = \u001B[39m\u001B[1mtrue\u001B[0m\n"));
}
...
TEST_CASE("braincheck_debug_array - ansi")
{
    ...
    REQUIRE_THAT(message, StartsWith("\u001B[0m\u001B[02m" __FILE__ ":"));
    REQUIRE_THAT(message, ContainsSubstring(":\u001B[0m \u001B[0m\u001B[34m"));
    REQUIRE_THAT(message, EndsWith(":\u001B[0m \u001B[36m\u001B[1mvalues\u001B[0m = \u001B[39m\u001B[1m[a, b, c]\u001B[0m\n"));
}
...
TEST_CASE("braincheck_debug_hexdump - ansi")
{
    ...
    REQUIRE_THAT(message, StartsWith("\u001B[0m\u001B[02m" __FILE__ ":"));
    REQUIRE_THAT(message, ContainsSubstring(":\u001B[0m \u001B[0m\u001B[34m"));
    REQUIRE_THAT(message, EndsWith(":\u001B[0m \u001B[36m\u001B[1mvalues\u001B[0m (length = 152)\n"
                                   "\u001B[39m\u001B[1m"
...
TEST_CASE("braincheck_perror - ansi")
{
    ...
    REQUIRE_THAT(message, StartsWith("\u001B[0m\u001B[02m" __FILE__ ":"));
    REQUIRE_THAT(message, ContainsSubstring(":\u001B[0m \u001B[0m\u001B[34m"));
    REQUIRE_THAT(message, EndsWith(":\u001B[0m \u001B[36m\u001B[1mSome maths operation\u001B[0m: \u001B[39m\u001B[1mNumerical argument out of domain\u001B[0m\n"));
}
