...
#define braincheck_once_assert_m(v, message)
#define braincheck_once_assert_nonnull_m(v, message)
...
#define braincheck_once_assert_m(v, message) do { static bool print = true; if (print) {braincheck_assert_m(v, message); print = false; } } while(0)
#define braincheck_once_assert_nonnull_m(v, message) do { static bool print = true; if (print) {braincheck_assert_nonnull_m(v, message); print = false; } } while(0)
